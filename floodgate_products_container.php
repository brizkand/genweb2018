<?php
    if(!empty($_POST['clickSatData'])){
        ...
        $sql = "select * from floodgate_products where id ='$satInfo'";
        ...
        if($result->num_rows > 0){
            ...
            <div class="card bg-info text-white">
                <div class="card-body">
                    <div class="row">
                        <div class="col-sm-3">
                            <img class="rounded" src="storage\genserv_products\floodgate_products\<?php echo $satImage;?>" alt="<?php echo $satTitle;?>" style="width:100%">
                        </div>
                        <div class="col-sm-9">
