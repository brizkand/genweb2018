        ...
        $(document).ready(function(){
            ...
            */
            $('.satData').on('click', function(){
			    var value = $(this).val();
                $.post('industrial_and_security_products_container.php',{clickSatData: value},function(result){
...
<body>
    ...
    <div id="app" class='container-fluid'>
        <main class="py-4">
            <div class='container'>
                <div class='jumbotron'>
                    <h1 class='text-center'><b>Industrial and Security Products</b></h1>
                </div>
                <div class="row">
                    <div class="col-sm-3 mb-2">
                        <div class="card mb-2">
                            <div class="card-body">
                                <h4 class="card-title text-center">CCTV Products</h4>
                                <button class="mb-1 btn btn-primary satData" value="1">Digital Video Recorder(DVR)</button>
                                <button class="mb-1 btn btn btn-primary satData" value="2">Bullet Camera</button>
                                <button class="mb-1 btn btn btn-primary satData" value="3">Dome Camera</button>    
                            </div>
                        </div>
                        <!--<div class="card mb-2">
                            <div class="card-body">
                                <h4 class="card-title text-center">LED Lights</h4>
                                <button class="mb-1 btn btn btn-primary satData" value="4">Bulb</button>
                                <button class="mb-1 btn btn btn-primary satData" value="5">	T8 Flourescent Light</button>
                            </div>
                        </div>-->
                        <div class="card mb-2">
                            <div class="card-body">
                                <h4 class="card-title text-center">Circulation Fan</h4>
                                <button class="mb-1 btn btn btn-primary satData" value="6">Ceiling Circulation Fan</button>
                            </div>
                        </div>
                        ...
                        <div class="card mb-2 bg-secondary text-white">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li>Koangyow Integration Machine(KIM)</li>
                                    <li>Lilin</li>
                                </ul>
                            </div>
                        </div>
                        ...
                        <div class="card" id="productsContainer">
                            <?php
                                if(isset($_GET['id'])){
                                    $test = $_GET['id'];
                                    include 'conn.php';
                                    $sql = "select * from industrial_and_security_products where id ='$test'";
                                    ...
                                    if($result->num_rows > 0){
                                        ...
                                        <div class="card bg-info text-white">
                                            <div class="card-body">
                                                <div class="row">
                                                    <div class="col-sm-3">
                                                        <img src="storage\genserv_products\industrial_and_security_products\<?php echo $satImage;?>" alt="<?php echo $satTitle;?>" style="width:100%">
                                                    </div>
                                                    <div class="col-sm-9">
                                    ...
                                    include 'conn.php';
                                    $sql = "select * from industrial_and_security_products where id ='1'";
                                    $result = $conn->query($sql);
                                    if($result->num_rows > 0){
                                        $row = $result->fetch_assoc();
                                        $satID = $row['id'];
