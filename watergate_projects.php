...
<body>
    ...
    <div id="app" class='container-fluid'>
        <main class="py-4">
            <div class='container'>
                <div class='jumbotron'>
                    <h1 class='text-center'><b>Watergate Finished Projects in Philippines</b></h1>
                </div>
                <div class="row">
                    <div class="col-sm-4">
                        <div class="card">
                            <img class="card-img-top" src="/storage/watergate_projects/steve1.png" alt="WATERGATE FINISHED PROJECTS" style="width:100%">
                            <div class="card-body">
                                <h2 class="card-title">Mr. Steve Su Watergate</h2>
                                <p class="card-text"><address>Quezon City</address>
                                </p>
                 ...
                 <div class="container" id="modalView">
                    ...
                    <?php
                        include 'conn.php';
                        $sql = "select * from watergate_projects where id = '1'";
                        $result = $conn->query($sql);
                        if($result->num_rows > 0){
                            $row = $result->fetch_assoc();
                            $wID = $row['id'];
                            $wClient = $row['client'];
                            $wLocation = $row['address'];
                            $wPic1 = $row['pic1'];
                            $wPic2 = $row['pic2'];
                            $wPic3 = $row['pic3'];
                        }
                            ...
                            <div class="modal-content">
                                <div class="modal-content">
                                    ...
                                    <div class="modal-header">
                                        <h4 class="modal-title"><?php echo $wClient;?></h4>
                                        ...
                                        ?>
                                                <div class="row">
                                                    <div class="col-sm-12">
                                                        <div class="card">
                                                            <div class="card-body">
                                                                <img class="card-img-top" src="/storage/watergate_projects/<?php echo 'steve' . $x . '.png';?>" alt="Mr. Steve Su Water Gate" style="width:100%">
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div></br> 
